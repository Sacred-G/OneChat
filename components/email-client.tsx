    ...
    const mockEmails: Email[] = [
      {
        ...
        to: ['you@company.com'],
        body: 'Hi team, I wanted to share the latest updates on our Q4 planning. We have made significant progress on the roadmap and I\'d like to schedule a meeting to discuss the next steps.',
      ...
      },
      {
        ...
        to: ['you@company.com'],
        body: 'Just a quick reminder about our meeting tomorrow at 2PM. We\'ll be discussing the new feature rollout and customer feedback.',
      ...
      },
      {
        ...
        body: 'Thank you for the proposal. I\'ve reviewed the numbers and everything looks good. Let\'s proceed with the implementation.',
