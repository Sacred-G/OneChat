                    ...
                    <div className="flex items-center gap-1 mb-2">
                      ...
                      <input
                        ...
                        onKeyDown={(e) => {
                          ...
                          if (e.key === "Escape") { setEditingId(null); setShowIconPicker(false); }
                        }}
                      ...
                      <button onClick={() => { setEditingId(null); setShowIconPicker(false); }} className="p-1 text-gray-400 hover:text-gray-300">
                        <X size={14} />
                      </button>
                    </div>
                    {showIconPicker && (
              ...
              <div className="flex items-center gap-1 mb-2">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    ...
                    if (e.key === "Escape") { setIsCreating(false); setShowIconPicker(false); }
                  }}
                ...
                <button onClick={() => { setIsCreating(false); setShowIconPicker(false); }} className="p-1 text-gray-400 hover:text-gray-300">
                  <X size={14} />
                </button>
              </div>
              {showIconPicker && (
