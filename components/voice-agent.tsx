...
export default function VoiceAgent({ onClose, onTranscript }: VoiceAgentProps) {
  ...
  const { vectorStore, webSearchEnabled, webSearchConfig, mcpEnabled, selectedVoice } = useToolsStore();
...
${skillInstructions}`,
  ...
  }, [addTranscript, searchVectorStoreTool, selectedSkill, webSearchTool, generateVideoTool, generateImageTool, generateImagesTool, generateArtifactTool, callMcpToolTool, listMcpToolsTool, listSkillsTool, selectedVoice, useSkillTool]);
