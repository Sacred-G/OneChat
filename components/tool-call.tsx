                ...
                return (
                  ...
                  >
                    <div className="aspect-square w-full bg-black/20">
                      <Image src={src} alt="Generated" width={400} height={400} className="h-full w-full object-cover" />
                    </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {editResults.map((src) => {
                      ...
                      return (
                        ...
                        >
                          <div className="aspect-square w-full bg-black/20">
                            <Image src={src} alt="Edited" width={400} height={400} className="h-full w-full object-cover" />
                          </div>
