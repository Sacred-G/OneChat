...
export async function GET(request: NextRequest) {
  ...
  const path = `/me/calendarView?startDateTime=${startTime}&endDateTime=${endTime}&$top=${top}&$orderby=start/dateTime&$select=id,subject,start,end,location,body,attendees,organizer,isAllDay,recurrence,showAs,importance,webLink`;
