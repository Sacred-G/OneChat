# Operational Procedures for Supported Living Agencies
...
3. TB test/clearance
4. Valid driver's license and insurance (if driving required)
...
- Emergency procedures and safety (2 hours)
- Documentation requirements and systems (2 hours)
- Shadow experienced DSS (minimum 8 hours)
...
- Consumer response/progress toward ISP goals
...
- Document within 24 hours of service delivery
- Ensure notes support billing for services provided
...
- ISP modification if needed
- Documentation of all follow-up actions
...
4. **Right Time**: Confirm scheduled time
5. **Right Route**: Oral, topical, etc. as prescribed
6. **Right Documentation**: Record observation immediately
7. **Right to Refuse**: Consumer may decline; document refusal
...
- Confidentiality and HIPAA (1 hour)
