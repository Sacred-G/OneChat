...
${code}
      ...
      // Use a stable ID based on type so that updated versions of the same
      // artifact replace the previous one instead of creating duplicates.
      const stableId = `artifact-${artifactType}-${artifactIndex}`;
