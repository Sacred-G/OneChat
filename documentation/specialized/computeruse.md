[Dashboard](https://platform.openai.com/chat)[Docs](https://platform.openai.com/docs)[API reference](https://platform.openai.com/docs/api-reference/introduction)[](https://platform.openai.com/settings)
...
[CUA sample appExamples of how to integrate the computer use tool in different environments](https://github.com/openai/openai-cua-sample-app)## Setting up your environment
...
```
defhandle_model_action(page, action):
"""
...
defcomputer_use_loop(instance, response):
"""
    Run the loop that executes computer actions until no 'computer_call' is found.
    """
whileTrue:
        computer_calls = [item for item in response.output if item.type == "computer_call"]
ifnot computer_calls:
...
[CUA sample appExamples of how to integrate the computer use tool in different environments](https://github.com/openai/openai-cua-sample-app)## Limitations
