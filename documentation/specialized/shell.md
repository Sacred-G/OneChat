...
Shell is available through the [Responses API](https://platform.openai.com/docs/guides/responses-vs-chat-completions) for use with `GPT-5.1` and newer models. It is not available via the Chat Completions API.
...
3. **Execute Shell Commands**
   ...
   **Important** :
   ...
   classShellExecutor:
   def__init__(self, default_timeout: float = 60):
           self.default_timeout = default_timeout

   defrun(self, cmd: str, timeout: float | None = None) -> CmdResult:
 ...
 */
classLocalShellimplementsShell{
...
[Shell tool example - TypeScriptExample of how to use the shell tool with the Agents SDK in TypeScript](https://github.com/openai/openai-agents-js/blob/main/examples/tools/shell.ts)[Shell tool example - PythonExample of how to use the shell tool with the Agents SDK in Python](https://github.com/openai/openai-agents-python/blob/main/examples/tools/shell.py)## Handling common errors
