...
* [Overview](https://platform.openai.com/docs/guides/prompt-caching#page-top)
* [Structuring prompts](https://platform.openai.com/docs/guides/prompt-caching#structuring-prompts)
* [How it works](https://platform.openai.com/docs/guides/prompt-caching#how-it-works)
* [Prompt cache retention](https://platform.openai.com/docs/guides/prompt-caching#prompt-cache-retention)
* [Requirements](https://platform.openai.com/docs/guides/prompt-caching#requirements)
* [Best practices](https://platform.openai.com/docs/guides/prompt-caching#best-practices)
* [Frequently asked questions](https://platform.openai.com/docs/guides/prompt-caching#frequently-asked-questions)
